document.addEventListener('DOMContentLoaded', () => {
  ...
  registrationForm.addEventListener('submit', async (event) => {
      ...
      try {
          const response = await fetch('http://matiasgasparg.pythonanywhere.com/users/create', {
              method: 'POST',
              headers: {
          ...
          if (response.ok) {
              ...
              window.location.href = "iniciosesion.html"; // Redireccionar a la página de servidores
